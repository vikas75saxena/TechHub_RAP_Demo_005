/********** GENERATED on 07/03/2022 at 23:11:38 by CB9980000000**************/
 @OData.entitySet.name: 'A_BusinessPartner' 
 @OData.entityType.name: 'A_BusinessPartnerType' 
 define root abstract entity ZUM_A_BUSINESSPARTNER { 
...
//On-condition is not relevant for runtime 
 _BuPaIdentification : association [0..*] to ZUM_A_BUPAIDENTIFICATION on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerAddress : association [0..*] to ZUM_A_BUSINESSPARTNERADDRESS on 1 = 1; 
 } 
